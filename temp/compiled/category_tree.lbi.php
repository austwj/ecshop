...
<div class="box1 cate" id="cate">
  <?php $_from = $this->_var['categories']; if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array'); }; $this->push_vars('', 'cat_0_53110600_1463902840');$this->_foreach['no'] = array('total' => count($_from), 'iteration' => 0);
if ($this->_foreach['no']['total'] > 0):
    foreach ($_from AS $this->_var['cat_0_53110600_1463902840']):
...
?>
  ...
  <a  <?php if (($this->_foreach['no']['iteration'] <= 1)): ?> style="border-top:none" <?php endif; ?> href="<?php echo $this->_var['cat_0_53110600_1463902840']['url']; ?>" class="  f_ll" ><?php echo htmlspecialchars($this->_var['cat_0_53110600_1463902840']['name']); ?></a>
  <ul style="display:none" class="sub-tree">
    <?php $_from = $this->_var['cat_0_53110600_1463902840']['cat_id']; if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array'); }; $this->push_vars('', 'child');if (count($_from)):
