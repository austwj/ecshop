...
<title>生活用品_我社演示站 - Powered by ECShop</title>
...
<div class="blank"></div>
 <div id="ur_here">
当前位置: <a href=".">首页</a> <code>&gt;</code> <a href="category.php?id=1">生活用品</a> 
</div>
</div>
<div class="blank"></div>
  ...
  <input type="hidden" name="order" value="DESC" />
      ...
      <form name="compareForm" action="compare.php" method="post" onSubmit="return compareGoods(this);">
            <div class="clearfix goodsBox" style="border:none;">
              <div class="goodsItem"> <a href="goods.php?id=2" target="_blank"><img src="images/201605/thumb_img/2_thumb_G_1463900572593.jpg" alt="旺仔小馒头" class="goodsimg" /></a><br />
        <p class="name"><a href="goods.php?id=2" title="旺仔小馒头" target="_blank">旺仔小馒头</a></p>
        <div class="info">
          <p class="price">
          ...
          <p class="market">￥14元</p>
          <a href="goods.php?id=2" class="buy" target="_blank">立即购买</a>
        </div>
      </div>
                  <div class="goodsItem"> <a href="goods.php?id=1" target="_blank"><img src="images/201605/thumb_img/1_thumb_G_1463900521143.jpg" alt="卫生纸" class="goodsimg" /></a><br />
        <p class="name"><a href="goods.php?id=1" title="卫生纸" target="_blank">卫生纸</a></p>
        <div class="info">
          <p class="price">
